function calcular() {
  ...
  if (n1 > 10 || n1 < 0 || n2 < 0 || n2 > 10) {
    ...
    var media = (n1 + n2) / 2
    if (media >= 8) {
      resultado.innerHTML = ` <div class="d-flex justify-content-end">
      <a href="home.html" type="button" class="btn btn-secondary btn-lg">
      ...
      resultado.innerHTML += `<a href="media.html" type="button" class="btn btn-secondary mt-3 mb-3">Retornar</a>`
      ...
      resultado.innerHTML += `<p id="media"> Média: ${media} <p>`
      resultado.innerHTML += `<h5 >QUE PENA! Você reprovou, não fique triste por muito tempo e dê seu melhor na próxima.</h5>`
      resultado.innerHTML += `<a href="media.html" type="button" class="btn btn-secondary mt-3 mb-3">Retornar</a>`
...
function mediaEnemPesos() {
  ...
  if (camposPreenchidos == 10) {
    ...
    resultado.innerHTML = `<img id="robo" src="img/chatbot.svg">`
    resultado.innerHTML += `<h3> Pelos meus cálculos sua média do ENEM é <strong class="text-primary"> ${media} </strong> </h3>`
    resultado.innerHTML += `<a href="media-pesos.html" type="button" class="btn btn-secondary mt-3 mb-3">Retornar</a>`
